...
@section('content')
	<div class="container-view">
		<div class="d-flex justify-content-between align-items-center mb-3">
			...
			<div>
				<a href="{{ route('resepsionis.temu-dokter.create') }}" class="btn btn-success btn-aksi shadow-sm">
					...
					<table class="table table-striped table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{ route('resepsionis.temu-dokter.edit', $temu->idtemu_dokter) }}" class="btn btn-warning btn-sm btn-aksi me-1" title="Ubah Status"><i class="bi bi-pencil-square"></i> Status</a>
								</td>
							</tr>
							@empty
							<tr>
