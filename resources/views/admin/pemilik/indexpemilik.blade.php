...
@section('content')
    <div class="container-view">
        ...
        <a href="{{ route('admin.pemilik.create') }}" class="btn btn-primary mb-3 btn-aksi shadow-sm">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $item->alamat }}</td>
                                <td>
                                    <a href="{{ route('admin.pemilik.edit', $item->idpemilik) }}" class="btn btn-warning btn-sm btn-aksi me-1">Edit</a>
                                    <form action="{{ route('admin.pemilik.destroy', $item->idpemilik) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus pemilik ini?');">
                                        @csrf
                                        @method('DELETE')
